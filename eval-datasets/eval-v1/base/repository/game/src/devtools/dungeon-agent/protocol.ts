...
/** 玩家可见的稳定动作入口；`tool` 指定由 act 还是 query 消费。 */
...
export interface DungeonAgentJudge {
  ...
  guidanceTargetKind: "none" | "room" | "live-monster" | "defeated-monster";
}
...
/**
 * `window.__DUNGEON_PLAYTEST__` 暴露的固定协议 1.0。
 *
